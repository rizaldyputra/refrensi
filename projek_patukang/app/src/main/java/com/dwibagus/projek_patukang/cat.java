...
import com.dwibagus.projek_patukang.Adapater.AdapaterDataCat;
import com.dwibagus.projek_patukang.Api.Url;
import com.dwibagus.projek_patukang.Model.ModelDataCat;
...
public class cat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SessionManager sessionManager = new SessionManager(cat.this);
        queue = Volley.newRequestQueue(cat.this);

        ActionBar actionBar;
        actionBar = getSupportActionBar();assert actionBar != null;
        actionBar.setTitle("Kategori Tukang Cat");
    ...
    public void reload(){
        RecyclerView  mRecyclerview = findViewById(R.id.rcy_beranda_cat);
        pd = new ProgressDialog(cat.this);
        mItems = new ArrayList<>();

        loadHome();

        mManager = new GridLayoutManager(cat.this,1);
        mRecyclerview.setLayoutManager(mManager);

        mAdapter = new AdapaterDataCat(this,mItems);
    ...
    private void loadHome() {
        ...
        StringRequest reqData = new StringRequest(Request.Method.POST, Url.API_BERANDA_CAT,
                        ...
                        try {
                            ...
                            for(int i = 0 ; i < response.length(); i++)
                            {
                                try {
                                    ...
                                    ModelDataCat md = new ModelDataCat();
