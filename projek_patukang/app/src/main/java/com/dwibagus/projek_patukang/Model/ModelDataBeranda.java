...
public class ModelDataBeranda {
    String id_tukang,foto_tukang,nama_tukang,keahlian_tukang,harga_tukang;

    public ModelDataBeranda(){}

    public ModelDataBeranda(String id_tukang,String foto_tukang, String nama_tukang, String keahlian_tukang,String harga_tukang) {
