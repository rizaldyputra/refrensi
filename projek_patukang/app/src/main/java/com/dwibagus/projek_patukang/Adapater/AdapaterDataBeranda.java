...
public class AdapaterDataBeranda extends RecyclerView.Adapter<AdapaterDataBeranda.HolderData> {
    private List<ModelDataBeranda> mItems ;
    private Context context;

    public AdapaterDataBeranda(Context context, List<ModelDataBeranda> items)
    {
        this.mItems = items;
    ...
    public HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_beranda,parent,false);
    ...
    public void onBindViewHolder(HolderData holder, int position) {
        ModelDataBeranda md  = mItems.get(position);
