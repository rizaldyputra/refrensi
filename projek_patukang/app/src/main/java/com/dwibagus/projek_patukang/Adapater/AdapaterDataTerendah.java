...
public class AdapaterDataTerendah extends RecyclerView.Adapter<AdapaterDataTerendah.HolderData> {
    private List<ModelDataTerendah> mItems ;
    private Context context;

    public AdapaterDataTerendah(Context context, List<ModelDataTerendah> items)
    {
        this.mItems = items;
    ...
    public HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_beranda_terendah,parent,false);
    ...
    public void onBindViewHolder(HolderData holder, int position) {
        ModelDataTerendah md  = mItems.get(position);
