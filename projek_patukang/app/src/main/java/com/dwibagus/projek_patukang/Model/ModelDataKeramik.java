...
public class ModelDataKeramik {
    String id_tukang,foto_tukang,nama_tukang,keahlian_tukang,harga_tukang;

    public ModelDataKeramik(){}

    public ModelDataKeramik(String id_tukang, String foto_tukang, String nama_tukang, String keahlian_tukang, String harga_tukang) {
