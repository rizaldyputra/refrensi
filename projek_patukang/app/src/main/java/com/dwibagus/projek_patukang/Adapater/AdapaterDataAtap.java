...
public class AdapaterDataAtap extends RecyclerView.Adapter<AdapaterDataAtap.HolderData> {
    private List<ModelDataAtap> mItems ;
    private Context context;

    public AdapaterDataAtap(Context context, List<ModelDataAtap> items)
    {
        this.mItems = items;
    ...
    public HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_beranda_atap,parent,false);
    ...
    public void onBindViewHolder(HolderData holder, int position) {
        ModelDataAtap md  = mItems.get(position);
