...
public class AdapaterDataCat extends RecyclerView.Adapter<AdapaterDataCat.HolderData> {
    private List<ModelDataCat> mItems ;
    private Context context;

    public AdapaterDataCat(Context context, List<ModelDataCat> items)
    {
        this.mItems = items;
    ...
    public HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_beranda_cat,parent,false);
    ...
    public void onBindViewHolder(HolderData holder, int position) {
        ModelDataCat md  = mItems.get(position);
