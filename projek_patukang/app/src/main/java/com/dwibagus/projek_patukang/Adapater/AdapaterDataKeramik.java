...
public class AdapaterDataKeramik extends RecyclerView.Adapter<AdapaterDataKeramik.HolderData> {
    private List<ModelDataKeramik> mItems ;
    private Context context;

    public AdapaterDataKeramik(Context context, List<ModelDataKeramik> items)
    {
        this.mItems = items;
    ...
    public HolderData onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_beranda_keramik,parent,false);
    ...
    public void onBindViewHolder(HolderData holder, int position) {
        ModelDataKeramik md  = mItems.get(position);
